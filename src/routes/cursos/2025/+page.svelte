<script lang="ts">
	...
	import { COURSES_2025 } from '$lib/data/courses';
...
<svelte:head>
	<title>Cursos do NUR — 2025</title>
</svelte:head>

<section class="wrap section-block">
	<div class="section-nav"><span class="label">Cursos do NUR — 2025</span></div>
	<div class="course-grid">
		{#each COURSES_2025 as course, i (course.slug)}
